-- Corregir la función de login para que devuelva el estado de la asignación (status).
-- El frontend (AuthContext) necesita este campo para validar si una asignación está activa.
