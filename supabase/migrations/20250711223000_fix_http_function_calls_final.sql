-- supabase/migrations/20250711223000_fix_http_function_calls_final.sql

-- Recreate the function, calling http_post and http_header with correct schema and type casting
...
BEGIN
    ...
    -- Call Edge Function to generate JWT, now with the correct apikey parameter and explicit type casting
    SELECT * FROM public.http_post(
        ...
        ARRAY[public.http_header('apikey'::character varying, p_supabase_anon_key::character varying)]
