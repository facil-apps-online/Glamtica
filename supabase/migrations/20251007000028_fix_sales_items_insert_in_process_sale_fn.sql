-- V11 of the function, fixing a NOT NULL violation on sales_items insert.
...
COMMENT ON FUNCTION public.process_sale_from_attention IS 'V11: Fix NOT NULL violation on sales_items insert by providing initial zero value for total_tax_amount.';
