-- Migration: 20250821000038_fix_check_user_availability_timezone_logic_v2.sql
-- Description: Fixes the timezone conversion for user schedules in check_user_availability.
