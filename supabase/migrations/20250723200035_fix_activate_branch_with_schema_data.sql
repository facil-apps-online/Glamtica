-- MIGRATION: Final correction for activate_branch based on DB_SCHEMA.md
...
BEGIN
    ...
    -- Step 4: Get plan details using the CORRECT column name from DB_SCHEMA.md
    ...
    -- Step 5: Proration Calculation with a safeguard for NULL end_date
    IF v_subscription.end_date IS NULL THEN
        -- This is a special case (like a demo tenant) and proration is not possible.
