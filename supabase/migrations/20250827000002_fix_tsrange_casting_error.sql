-- Migration: Fix TSRANGE casting error from previous migration

-- Step 1: Drop the functions created in the previous migration to re-apply them correctly.
...
-- Step 2: Recreate the is_time_in_schedule function with correct casting
...
-- Step 3: Recreate the check_user_availability function with correct casting
