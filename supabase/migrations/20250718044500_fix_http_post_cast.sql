-- Corregir la función de envío para usar el tipo de dato correcto en http_post y recrear la función dependiente.
...
-- 2. Crear la función trabajadora con la corrección del CAST a TEXT.
...
BEGIN
    ...
    -- NOTA: La lógica de refresco de token se omite temporalmente para validar el flujo principal.
    ...
    -- Enviar el correo a través de la API de Gmail con el CAST correcto
    SELECT content INTO v_response FROM http_post(
        'https://gmail.googleapis.com/gmail/v1/users/me/messages/send',
        v_request_body::text, -- <-- CORRECCIÓN FINAL
        'application/json',
