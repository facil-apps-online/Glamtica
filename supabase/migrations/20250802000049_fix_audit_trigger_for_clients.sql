-- Step 0: Update the audit trigger function to be compatible with the new clients table structure
...
BEGIN
    IF TG_OP = 'INSERT' THEN
        ...
        ELSIF TG_TABLE_NAME = 'clients' THEN
            v_tenant_id := NEW.tenant_id;
            v_branch_id := NULL; -- branch_id is no longer on the clients table
        ELSE
            v_tenant_id := NEW.tenant_id;
