-- V7 of the function, adding the payment receipt notification.
...
BEGIN
    ...
    -- Step 7: Enqueue client notification email for the payment receipt
    BEGIN
        PERFORM public.queue_client_email(
            p_attention_id := p_attention_id,
            p_tenant_id := attention_rec.tenant_id,
            p_template_name := 'payment_receipt'
        );
    EXCEPTION
        WHEN others THEN
...
COMMENT ON FUNCTION public.process_sale_from_attention IS 'V7: Add payment receipt notification.';
