-- This migration restores the correct, context-based audit functions.
-- This version uses a custom session variable 'audit.context' which is set by the application
-- via the set_audit_context function, ensuring a reliable way to capture user information.

-- Step 1: Create the function to set the audit context in a session variable.
