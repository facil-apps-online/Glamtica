-- Migration to correct the setup_tenant_for_new_user RPC.
-- Removes the incorrect reference to 'country_id' in the branches INSERT statement,
-- as 'country_id' is not a column in the branches table according to the provided schema.
