-- This migration updates the login_user function to return the user's name.
...
DECLARE
    user_record RECORD;
BEGIN
    -- Find the user by email and include the new name fields
    SELECT
    ...
    -- Return user data, now including the name
