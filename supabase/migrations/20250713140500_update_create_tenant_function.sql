-- Eliminar la función existente para poder recrearla
DROP FUNCTION IF EXISTS public.create_tenant_with_admin;

-- Crear la nueva versión de la función con todos los parámetros
...
BEGIN
    ...
    -- 2. Obtener el ID del rol 'tenant_super_admin'
