...
CREATE OR REPLACE FUNCTION public.login_user(
    ...
    p_edge_function_base_url TEXT DEFAULT NULL -- Nueva URL base de Edge Function
)
RETURNS JSON AS $$
DECLARE
    user_record RECORD;
...
BEGIN
    ...
    -- Construct Edge Function URL using provided base URL
    IF p_edge_function_base_url IS NULL OR p_edge_function_base_url = '' THEN
        RAISE EXCEPTION 'Edge Function base URL is not provided.';
    END IF;
    edge_function_url := p_edge_function_base_url || '/generate-jwt';
