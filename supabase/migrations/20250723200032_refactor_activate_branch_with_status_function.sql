-- MIGRATION: Refactor activate_branch to use get_tenant_subscription_status function
...
BEGIN
    -- Step 1: Verify the tenant has an active subscription using the correct function
    ...
    -- Step 3: Get the latest subscription record to find the plan and dates for proration
    SELECT * INTO v_subscription FROM public.tenant_subscriptions WHERE tenant_id = p_tenant_id ORDER BY end_date DESC NULLS FIRST LIMIT 1;
