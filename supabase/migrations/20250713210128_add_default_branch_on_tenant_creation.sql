-- This migration updates the tenant creation function to automatically
-- add a default "Principal" branch, using the correct table columns.
...
BEGIN
    ...
    VALUES (new_tenant_id, 'Principal', create_tenant_with_admin.physical_address_line1);
