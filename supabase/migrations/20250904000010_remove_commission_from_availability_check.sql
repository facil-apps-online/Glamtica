-- MIGRATION TO FINALLY FIX AND SIMPLIFY USER AVAILABILITY CHECK (NO COMMISSIONS)
...
-- Step 2: Recreate the function without any commission logic, only checking for service assignment.
...
BEGIN
    ...
    WHERE
        ...
        -- Filter for users who can perform the service/combo
        AND EXISTS (
            SELECT 1
