-- Implementar la lógica de refresco de token completa y recrear las funciones dependientes.
...
-- 2. Crear la función trabajadora con la lógica de refresco de token completa.
