-- supabase/migrations/20250711220000_fix_http_post_schema_qualifier.sql

-- Recreate the function, calling http_post with its schema qualifier
...
BEGIN
    ...
    SELECT * FROM extensions.http_post(
        ...
        ARRAY[extensions.http_header('apikey', p_supabase_anon_key)]
