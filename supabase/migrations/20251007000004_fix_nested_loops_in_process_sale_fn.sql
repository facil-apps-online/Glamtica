-- V4 of the function, fixing nested loop variable shadowing.
...
COMMENT ON FUNCTION public.process_sale_from_attention IS 'V4: Fix nested loop variable shadowing.';
