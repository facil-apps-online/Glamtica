-- Migration: Fix "more than one row returned by a subquery" error in get_attentions_with_details.
-- This ensures the tenant_users CTE has unique user_id records.
