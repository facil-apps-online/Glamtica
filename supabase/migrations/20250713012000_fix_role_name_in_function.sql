-- Migración para corregir el nombre del rol en la función create_tenant_with_admin

-- Reemplazamos la función existente con la versión corregida.
-- El único cambio es usar el nombre de rol correcto: 'tenant_super_admin'.
...
BEGIN
    ...
    -- 2. Obtener el ID del rol 'tenant_super_admin' (CORREGIDO)
