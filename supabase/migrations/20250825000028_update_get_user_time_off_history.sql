-- Migration: Update get_user_time_off_history to fix ambiguous user_id reference
...
BEGIN
    ...
    WITH tenant_users AS (
        SELECT
            user_id AS tu_user_id,
            first_name,
            last_name,
            email,
            branch_id AS tu_branch_id,
            branch_name
    ...
    JOIN
        tenant_users tu ON uto.user_id = tu.tu_user_id AND uto.branch_id = tu.tu_branch_id
    WHERE
