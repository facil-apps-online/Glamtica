-- Migration: 20250821000042_recreate_check_user_availability_after_gist.sql
-- Description: Recreates the check_user_availability function after btree_gist extension has been enabled.
