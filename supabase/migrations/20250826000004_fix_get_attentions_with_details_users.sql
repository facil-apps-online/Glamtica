-- Migration: Fix get_attentions_with_details to include user details.
-- This adds the 'users' object to attention_services, attention_products,
-- and attention_combos to match the frontend's expected data structure.
