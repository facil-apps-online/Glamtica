-- Migration to fix create_full_attention to not insert time/parallel data into attention_combos
...
BEGIN
    ...
    IF jsonb_array_length(p_combos) > 0 THEN
        ...
        LOOP
            -- Insert the main combo record for the attention (WITHOUT time/parallel fields)
            ...
            LOOP
                ...
                IF v_combo_item.service_id IS NOT NULL THEN
                    ...
                    INSERT INTO public.attention_services(
                        attention_id, service_id, user_id, service_price, notes, tenant_id, branch_id, 
                        duration_minutes, attention_combo_id, status, start_time, end_time, 
