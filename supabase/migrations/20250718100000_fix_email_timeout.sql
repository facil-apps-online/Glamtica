-- Aumentar el timeout en la función de envío de correo para evitar cancelaciones prematuras.

-- 1. Eliminar las funciones dependientes para poder modificar la función trabajadora.
...
-- 2. Recrear la función trabajadora con un timeout más largo.
...
-- 3. Recrear la función orquestadora
