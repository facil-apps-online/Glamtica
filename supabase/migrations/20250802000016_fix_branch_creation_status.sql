...
BEGIN
    ...
    INSERT INTO branches (tenant_id, name, is_main_branch, address_line_1, city, state, postal_code, country_id, status, activated_at)
    VALUES (new_tenant_id, 'Sucursal Principal', true, p_physical_address_line1, p_physical_city, p_physical_state, p_physical_postal_code, p_country_id, 'active', NOW())
