-- Migration to fix the create_full_attention function to use duration_minutes
...
BEGIN
    ...
    IF jsonb_array_length(p_services) > 0 THEN
        ...
        LOOP
            INSERT INTO public.attention_services (attention_id, service_id, user_id, service_price, notes, tenant_id, branch_id, duration_minutes, start_time, end_time)
        ...
        LOOP
            ...
            LOOP
                ...
                IF v_combo_item.service_id IS NOT NULL THEN
                    ...
                    INSERT INTO public.attention_services(attention_id, service_id, user_id, service_price, notes, tenant_id, branch_id, duration_minutes, combo_id, status)
