-- supabase/migrations/20250711214500_fix_http_post_type_casting.sql

-- Recreate the function with explicit type casting for http_post
...
BEGIN
    ...
    SELECT * FROM http_post(
        ...
        'application/json'::text, -- Explicitly cast to text
        ARRAY[http_header('apikey', p_supabase_anon_key)]
