-- Migration to revert the changes from migration 20250802000016.
-- This restores the create_tenant_and_admin_logic function to its original state
-- before the explicit status and activated_at fields were added to the branch creation.
