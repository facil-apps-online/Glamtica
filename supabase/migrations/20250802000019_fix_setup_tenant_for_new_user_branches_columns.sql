-- Migration to fix column names in branches table for setup_tenant_for_new_user RPC.
-- Corrects the INSERT statement to use existing columns like physical_address_line1,
-- physical_city, physical_state, physical_postal_code, status, and activated_at.
...
BEGIN
    ...
    INSERT INTO public.branches (
        ...
        physical_state,
        physical_postal_code,
        country_id, -- Asegurarse de que country_id se pase correctamente
        status,
        activated_at,
        contact_phone,
        whatsapp_phone,
        ...
        p_tenant_data->>'physical_state',
        p_tenant_data->>'physical_postal_code',
        (p_tenant_data->>'country_id')::UUID, -- Asegurarse de que country_id se pase correctamente
        'active',
        NOW(),
        p_tenant_data->>'contact_phone',
        p_tenant_data->>'whatsapp_phone',
