-- Paso 2.1: Refactorizar la función de login para que verifique el estado en user_assignments.
-- La función ahora comprueba si el usuario tiene al menos una asignación activa.
