-- Migration: Fixes a check constraint violation by correcting the status value from 'En Progreso' to 'En Proceso' in the start_service function.
...
BEGIN
    ...
    SET
        status = 'En Proceso', -- Corrected value
    ...
    IF FOUND THEN
        ...
        VALUES
            (p_attention_service_id, 'En Proceso', v_tenant_id, v_branch_id, v_user_id); -- Corrected value
