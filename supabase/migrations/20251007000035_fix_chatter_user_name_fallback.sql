-- Corrige la función del chatter para usar el email como fallback si el nombre del usuario está vacío.
-- Esto evita que aparezca "Sistema" para usuarios válidos sin nombre y apellido en su perfil.
-- También incluye las correcciones anteriores (DISTINCT ON y mapeo de event_type).
