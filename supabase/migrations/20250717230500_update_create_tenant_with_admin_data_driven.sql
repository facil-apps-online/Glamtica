...
BEGIN
    ...
    -- 5. Populate default template settings for the new tenant based on the 'propagate' flag
    ...
    WHERE
        ...
        AND tenant_id = '00000000-0000-0000-0000-000000000000' -- Ensure we only use master templates
    GROUP BY template_type; -- Use GROUP BY to prevent duplicates if multiple language versions have the flag.

    -- 6. Return the ID of the created tenant
