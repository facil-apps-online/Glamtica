-- MIGRACIÓN PARA AÑADIR DURACIÓN A LOS DETALLES DE COMBOS
-- Modifica la función get_combo_branch_details para que los items de tipo servicio incluyan su duración en minutos.
        ...
        'items', (
            SELECT COALESCE(jsonb_agg(
                jsonb_build_object(
                    ...
                    'duration_minutes', s.duration_minutes -- Añadido para que el frontend pueda calcular la duración total
                )
            ), '[]'::jsonb)
            FROM combo_items ci
