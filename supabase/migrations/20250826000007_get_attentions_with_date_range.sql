-- Migration: Update get_attentions_with_details to support date ranges.
-- This changes the function to accept a start and end date for filtering attentions.

-- Step 1: Drop the old function.
-- Note: The signature matches the previously deployed version.
DROP FUNCTION IF EXISTS get_attentions_with_details(uuid, uuid, uuid, text, date) CASCADE;

-- Step 2: Create the new function with date range parameters.
