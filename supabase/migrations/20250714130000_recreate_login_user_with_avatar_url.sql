...
DECLARE
    user_record RECORD;
BEGIN
    -- Find the user by email and include the name fields and avatar_url
    SELECT
        u.id, u.password_hash, u.tenant_id, u.branch_id, r.name AS role_name, u.first_name, u.last_name, u.avatar_url
    INTO
        user_record
    FROM
        public.users u
    ...
    -- Return user data including the name and avatar_url
    RETURN json_build_object(
        ...
        'avatar_url', user_record.avatar_url -- Add avatar_url here
    );
END;
$$;
