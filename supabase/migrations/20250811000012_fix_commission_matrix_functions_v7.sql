-- Migración para corregir las funciones de matriz de comisiones de productos y servicios (v7).
...
BEGIN
  ...
  relevant_users AS (
    ...
    FROM
        auth.users u,
        jsonb_array_elements(u.raw_app_meta_data::jsonb->'assignments') AS assignment
    WHERE
  ...
  LEFT JOIN public.product_user_commissions pc -- CORRECCIÓN: product_commissions cambiado a product_user_commissions
