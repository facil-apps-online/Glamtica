-- Migration to fix create_full_attention to correctly cascade parallel data to services within combos
        ...
        LOOP
            ...
            LOOP
                ...
                IF v_combo_item.service_id IS NOT NULL THEN
                    ...
                    INSERT INTO public.attention_services(
                        attention_id, service_id, user_id, service_price, notes, tenant_id, branch_id, 
                        duration_minutes, attention_combo_id, status, is_parallel, parallel_group_id, offset_minutes
                    )
                    VALUES (
                        v_attention_id, 
                        v_combo_item.service_id, 
                        (v_combo->>'user_id')::uuid, 
                        COALESCE(v_branch_service.selling_price, 0), 
                        v_combo->>'notes', 
                        p_tenant_id, 
                        p_branch_id, 
                        COALESCE(v_branch_service.duration_minutes, 0), 
