...
BEGIN
    -- Hash the password securely using pgcrypto.crypt with a generated salt
    ...
    -- Set branch_id to NULL for tenant_super_admin users
    INSERT INTO public.users (email, password_hash, role_id, tenant_id, branch_id, is_active)
    VALUES (p_admin_email, v_hashed_password, v_role_id, v_tenant_id, NULL, TRUE); -- branch_id is NULL
