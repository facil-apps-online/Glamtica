...
-- Then, create the corrected function
CREATE FUNCTION public.get_attentions_with_details(
    p_tenant_id uuid,
        ...
        (
            SELECT json_agg(
                json_build_object(
                    ...
                    'status', s.status,
                    'notes', s.notes,
                    'user_id', s.user_id, -- Keep user_id
        ...
        (
            SELECT json_agg(
                json_build_object(
                    ...
                    'notes', p.notes,
                    'user_id', p.user_id, -- Keep user_id
        ...
        (
            SELECT json_agg(
                json_build_object(
                    ...
                    'status', ac.status,
                    'user_id', ac.user_id, -- Keep user_id
