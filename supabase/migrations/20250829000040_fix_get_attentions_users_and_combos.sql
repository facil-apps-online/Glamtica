-- Migration to fix the get_attentions_with_details RPC to include user names via get_tenant_users and combo item details.
...
BEGIN
    ...
    WITH base_attentions AS (
        ...
        WHERE a.tenant_id = p_tenant_id
          ...
          AND (p_user_id IS NULL OR p_user_id::text = 'all' OR EXISTS (
              SELECT 1
    ...
    SELECT
        ...
        (
            ...
            LEFT JOIN get_tenant_users(p_tenant_id) u ON s.user_id = u.user_id
        ...
        (
            ...
            LEFT JOIN get_tenant_users(p_tenant_id) u ON p.user_id = u.user_id
        ...
        (
            ...
            LEFT JOIN get_tenant_users(p_tenant_id) u ON ac.user_id = u.user_id
