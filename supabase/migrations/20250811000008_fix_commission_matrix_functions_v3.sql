-- Migración para corregir las funciones de matriz de comisiones de productos y servicios (v3).
...
BEGIN
  ...
  relevant_users AS (
    ...
    FROM
        auth.users u,
        jsonb_array_elements(u.raw_user_meta_data->'assignments') AS assignment -- Sin CAST explícito
    WHERE
