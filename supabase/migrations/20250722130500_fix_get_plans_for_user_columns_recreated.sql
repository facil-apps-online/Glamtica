-- Migración para corregir el error en get_subscription_plans_for_user.
-- Se eliminan las columnas inexistentes (plan_description, plan_features) de la selección.
