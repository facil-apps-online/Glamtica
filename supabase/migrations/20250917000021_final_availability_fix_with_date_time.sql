-- MIGRATION: Definitive fix for check_user_availability, following correct architecture.
...
-- This version calls get_tenant_users and does NOT join to auth.users, respecting the desired architecture.
