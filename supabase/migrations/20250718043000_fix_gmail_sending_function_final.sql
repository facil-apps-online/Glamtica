-- Corregir la función de envío para que use la estructura de tabla correcta y recrear la función dependiente.
...
-- 2. Crear la función trabajadora con la estructura de tabla correcta.
