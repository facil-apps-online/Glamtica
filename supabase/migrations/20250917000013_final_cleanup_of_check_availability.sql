-- MIGRATION: Final V3 - Cleanup and recreate check_user_availability with a single TIMESTAMPTZ parameter.
...
-- Drop any previous versions with TIMESTAMPTZ just in case
...
BEGIN
    ...
    -- The input p_appointment_datetime is assumed to be in UTC from the Edge Function.
