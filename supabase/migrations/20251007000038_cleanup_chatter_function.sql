-- VERSIÓN FINAL Y LIMPIA de la función del chatter.
-- Elimina el código de depuración (columna debug_version y strings JOIN_SUCCESS/FAILED).
-- Mantiene todas las correcciones: DISTINCT ON, fallback de nombre/email, y permisos de audit_logs.
