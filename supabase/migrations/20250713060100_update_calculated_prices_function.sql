-- Migración para actualizar la función get_calculated_plan_prices
-- Se modifica para que utilice la nueva tabla de historial de precios (plan_price_history)
-- y obtenga el precio vigente más reciente para cada plan.
