-- Migration to fix the get_attentions_with_details RPC by correctly aliasing combo_id
...
BEGIN
  ...
  SELECT
    ...
    (SELECT json_agg(json_build_object(
        ...
        'notes', aserv.notes, 
        'status', aserv.status, 
        'attention_combo_id', aserv.combo_id, -- Corrected: Alias combo_id
    ...
    (SELECT json_agg(json_build_object(
        ...
        'attention_combo_id', ap.combo_id, -- Corrected: Alias combo_id
