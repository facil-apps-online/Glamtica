-- Migration: 20250821000040_fix_check_user_availability_tsrange.sql
-- Description: Fixes the tsrange function call in check_user_availability by adding explicit type cast for bounds.
