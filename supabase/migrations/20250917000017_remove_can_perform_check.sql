...
-- This version uses TIMESTAMPTZ and does NOT check for can_perform.
...
BEGIN
    ...
    WHERE
        ...
        AND (
            ( -- Main availability logic block: Schedule and Time Off
                EXISTS (
                    SELECT 1
