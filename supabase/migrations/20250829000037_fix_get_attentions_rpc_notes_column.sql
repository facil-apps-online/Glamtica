...
-- Then, create the corrected function removing the non-existent 'p.notes' column
        ...
        (
            SELECT json_agg(
                json_build_object(
                    ...
                    -- 'notes', p.notes, -- REMOVED a.notes as there is no notes column in attention_products
                    'user_id', p.user_id,
