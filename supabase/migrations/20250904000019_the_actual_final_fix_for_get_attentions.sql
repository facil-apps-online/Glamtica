-- Migration: This migration corrects the get_attentions_with_details RPC function by removing the erroneous reference to ac.user_id in the JSON object construction for attention_combos.
