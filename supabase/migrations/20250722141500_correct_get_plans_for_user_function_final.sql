-- Migración definitiva para corregir la función get_subscription_plans_for_user.
-- Se asegura que la función no seleccione columnas que no existen en la función subyacente.
...
IS 'Devuelve los planes de suscripción activos con precios calculados para el país del tenant al que pertenece el usuario.';
