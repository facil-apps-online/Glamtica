-- Corregir la llamada a http_post para usar la firma (text, jsonb, jsonb) y recrear la función dependiente.
...
-- 2. Crear la función trabajadora con el cuerpo como JSONB en la llamada a http_post.
...
BEGIN
    ...
    -- Enviar el correo usando la firma http_post(url, body, headers)
    SELECT content INTO v_response FROM http_post(
        'https://gmail.googleapis.com/gmail/v1/users/me/messages/send',
        v_request_body, -- <-- CORRECCIÓN: Se mantiene como JSONB
        jsonb_build_object(
