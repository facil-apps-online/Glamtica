-- Migration to update the create_full_attention function to handle parallel services/combos
    ...
    IF jsonb_array_length(p_services) > 0 THEN
        ...
        LOOP
            INSERT INTO public.attention_services (
                ...
                duration_minutes, start_time, end_time, is_parallel, parallel_group_id, offset_minutes
            )
            VALUES (
                v_attention_id, 
    ...
    IF jsonb_array_length(p_combos) > 0 THEN
        ...
        LOOP
            ...
            INSERT INTO public.attention_combos (
                ...
                start_time, end_time, is_parallel, parallel_group_id, offset_minutes
            )
            VALUES (
                v_attention_id, 
            ...
            LOOP
                ...
                IF v_combo_item.service_id IS NOT NULL THEN
                    ...
                    INSERT INTO public.attention_services(attention_id, service_id, user_id, service_price, notes, tenant_id, branch_id, duration_minutes, attention_combo_id, status)
                ...
                IF v_combo_item.product_id IS NOT NULL THEN
                    ...
                    INSERT INTO public.attention_products(attention_id, product_id, user_id, quantity, unit_price, total_price, tenant_id, branch_id, attention_combo_id)
