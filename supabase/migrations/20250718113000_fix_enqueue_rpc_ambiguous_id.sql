-- Corregir la ambigüedad de la columna 'id' en la RPC de encolado.
...
BEGIN
    -- 1. Encontrar al super_admin del sistema, especificando u.id
    SELECT u.id INTO v_super_admin_user_id
    FROM public.users u
