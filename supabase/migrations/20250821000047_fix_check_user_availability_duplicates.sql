-- Migration: 20250821000047_fix_check_user_availability_duplicates.sql
-- Description: Fixes duplicate user issue in check_user_availability by using DISTINCT ON.
...
BEGIN
    ...
    RETURN QUERY
    SELECT DISTINCT ON (tu.user_id) -- <<< FIX: Ensure unique users
        tu.user_id,
