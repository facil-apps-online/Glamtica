-- Migración para corregir la definición de la función get_subscription_plans_for_user.
-- Se elimina la columna 'price_id' que no es devuelta por la función subyacente.
