-- This migration creates the function to verify a reset token and update a user's password.
...
GRANT EXECUTE ON FUNCTION public.update_password_with_token(TEXT, TEXT) TO public;
