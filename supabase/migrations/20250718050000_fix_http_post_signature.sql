-- Corregir la llamada a http_post para usar la firma de 3 argumentos y recrear la función dependiente.
...
-- 2. Crear la función trabajadora con la firma http_post(url, body, headers) correcta.
