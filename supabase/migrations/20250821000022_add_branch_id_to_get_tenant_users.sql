-- Migration: 20250821000022_add_branch_id_to_get_tenant_users.sql
-- Description: Updates the get_tenant_users function to include branch_id in the output.
-- This is a non-breaking change that adds a new column to the result set.
...
RETURNS TABLE (
  ...
  branch_id UUID, -- Added branch_id
  branch_name TEXT,
  status TEXT
)
LANGUAGE plpgsql
...
BEGIN
    ...
    SELECT
        ...
        (assignment ->> 'branch_id')::uuid AS branch_id, -- Added branch_id
