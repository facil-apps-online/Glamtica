-- Migración para corregir las funciones de matriz de comisiones de productos y servicios (v4).
...
BEGIN
  ...
  relevant_users AS (
    ...
    FROM
        auth.users u,
        jsonb_array_elements(u.raw_app_meta_data->'assignments') AS assignment -- CORRECCIÓN: raw_user_meta_data cambiado a raw_app_meta_data
    WHERE
