-- Migration: Fix permissions in get_attentions_with_details by using get_tenant_users() RPC

-- Step 1: Drop the old, incorrect function.
...
BEGIN
  ...
  WITH tenant_users AS (
    SELECT u.user_id, u.first_name, u.last_name, u.email, u.phone, u.avatar_url, u.role_name
