-- Drop existing create_full_attention functions to ensure a clean slate
...
-- Create the correct create_full_attention function
...
BEGIN
    ...
    -- Insertar cada producto de la atención
    IF jsonb_array_length(p_products) > 0 THEN
        FOR v_product IN SELECT * FROM jsonb_array_elements(p_products)
        LOOP
