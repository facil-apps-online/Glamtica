...
BEGIN
    INSERT INTO equipment (tenant_id, name, type_id, brand_id, model, serial_number, purchase_date, last_maintenance_date, maintenance_frequency, maintenance_frequency_unit, notes)
    VALUES (
        (p_equipment_data->>'tenant_id')::uuid,
        p_equipment_data->>'name',
        (p_equipment_data->>'type_id')::uuid,
        (p_equipment_data->>'brand_id')::uuid,
...
BEGIN
    ...
    SET
        ...
        brand_id = (p_equipment_data->>'brand_id')::uuid,
