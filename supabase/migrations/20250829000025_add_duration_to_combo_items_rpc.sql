-- Migration to add duration_minutes to combo item services in get_attentions_with_details RPC

-- Step 1: Drop the existing function to replace it.
DROP FUNCTION IF EXISTS get_attentions_with_details(uuid, uuid, uuid, text, date, date) CASCADE;

-- Step 2: Create the new version with the updated combo_items -> service JSON object.
