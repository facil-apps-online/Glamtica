...
DROP FUNCTION IF EXISTS public.reschedule_attention(uuid, timestamptz, text) CASCADE;

CREATE OR REPLACE FUNCTION public.reschedule_attention(
    p_attention_id UUID,
...
BEGIN
    ...
    VALUES (p_attention_id, v_client_id, v_original_date, p_new_datetime, p_reason, v_user_id, p_fault);
