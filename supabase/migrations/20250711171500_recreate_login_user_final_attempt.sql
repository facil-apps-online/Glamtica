DROP FUNCTION IF EXISTS public.login_user(TEXT, TEXT, INET, TEXT, TEXT); -- Drop 5-param version
DROP FUNCTION IF EXISTS public.login_user(TEXT, TEXT, INET, TEXT, TEXT, TEXT); -- Drop 6-param version
DROP FUNCTION IF EXISTS public.login_user; -- Drops all overloads of login_user by name
...
CREATE OR REPLACE FUNCTION public.login_user(
    ...
    p_audience TEXT DEFAULT NULL      -- Audience
)
RETURNS JSON AS $$
DECLARE
    user_record RECORD;
...
BEGIN
    ...
    SELECT * FROM http_post(
        ...
        'application/json',
        ARRAY[http_header('apikey', p_supabase_anon_key)] -- Use p_supabase_anon_key
