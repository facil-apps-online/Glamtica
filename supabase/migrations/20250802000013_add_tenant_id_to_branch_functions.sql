...
COMMENT ON FUNCTION public.create_branch(UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, NUMERIC, NUMERIC) IS 'Creates a new non-main branch for the specified tenant with detailed information.';
...
COMMENT ON FUNCTION public.update_branch(UUID, UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, NUMERIC, NUMERIC) IS 'Updates an existing branch for the specified tenant with detailed information.';