-- Corrige la función log_audit_action para que pueda identificar al usuario que la invoca.
-- Cambia de SECURITY DEFINER a SECURITY INVOKER para que auth.uid() funcione correctamente.
...
END;
$$ LANGUAGE plpgsql SECURITY INVOKER; -- CAMBIO CLAVE: de DEFINER a INVOKER
