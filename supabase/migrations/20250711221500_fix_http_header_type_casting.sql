-- supabase/migrations/20250711221500_fix_http_header_type_casting.sql

-- Recreate the function, calling http_header with explicit type casting
...
BEGIN
    ...
    SELECT * FROM extensions.http_post(
        ...
        ARRAY[extensions.http_header('apikey'::text, p_supabase_anon_key)] -- Explicitly cast 'apikey' to text
