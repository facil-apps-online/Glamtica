        ...
        <CardContent>
          <Tabs defaultValue="es" className="w-full">
            ...
            <TabsContent value="es" className="prose max-w-none mt-4">
              ...
              <p>Bienvenido a Glamtica.app. Estos Términos de Servicio ("Términos") rigen su acceso y uso de los servicios de Glamtica.app (el "Servicio"). Al acceder o utilizar el Servicio, usted acepta estar sujeto a estos Términos.</p>
              ...
              <p>El Servicio y su contenido original, características y funcionalidad son y seguirán siendo propiedad exclusiva de Glamtica.app y sus licenciantes. El Servicio está protegido por derechos de autor, marcas comerciales y otras leyes tanto de Colombia como de países extranjeros.</p>
            ...
            <TabsContent value="en" className="prose max-w-none mt-4">
                ...
                <p>Welcome to Glamtica.app. These Terms of Service ("Terms") govern your access to and use of the Glamtica.app services (the "Service"). By accessing or using the Service, you agree to be bound by these Terms.</p>
                ...
                <p>The Service and its original content, features, and functionality are and will remain the exclusive property of Glamtica.app and its licensors. The Service is protected by copyright, trademark, and other laws of both Colombia and foreign countries.</p>
