...
>(({ className, ...props }, ref) => {
  ...
  console.log('SidebarFooter: tenantId', tenantId);
  console.log('SidebarFooter: isLoadingStorage', isLoadingStorage);
  console.log('SidebarFooter: storageUsage', storageUsage);
