...
import { useCreateTreatmentCategory, useUpdateTreatmentCategory, TreatmentCategory } from "@/hooks/useTreatmentCategories";
...
export const TreatmentCategoryDialog = ({ category, trigger, onOpenChange }: TreatmentCategoryDialogProps) => {
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            {category ? "Editar Categoría de Tratamiento" : "Nueva Categoría de Tratamiento"}
          </DialogTitle>
        </DialogHeader>
          ...
          <TabsContent value="general">
            <form onSubmit={handleSubmit} className="grid gap-4 py-4">
              <div className="grid gap-2">
                ...
                <Input id="name" value={name} onChange={(e) => setName(e.target.value)} placeholder="Ej: Faciales" required />
              </div>
              <div className="grid gap-2">
